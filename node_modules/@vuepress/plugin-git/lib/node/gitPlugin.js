    ...
    return {
        ...
        extendsPageData: async (page) => {
            ...
            if (createdTime !== false) {
                git.createdTime = await (0, utils_1.getCreatedTime)(page.filePathRelative, cwd);
            }
            if (updatedTime !== false) {
                git.updatedTime = await (0, utils_1.getUpdatedTime)(page.filePathRelative, cwd);
            }
            if (contributors !== false) {
                git.contributors = await (0, utils_1.getContributors)(page.filePathRelative, cwd);
            }
            return { git };
        },
    };
